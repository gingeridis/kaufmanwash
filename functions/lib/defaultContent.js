/* ============================================================
   Default site content — used to seed KV the first time the admin
   dashboard loads, and as the fallback if KV has nothing saved yet.
   Keep this in sync with what the pages looked like at launch;
   after that, KV (edited from /admin) is the source of truth.
   ============================================================ */
